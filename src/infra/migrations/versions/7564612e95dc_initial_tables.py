...
Revision ID: 7564612e95dc
Revises: 
Create Date: 2025-02-18 23:18:24.184431
...
def upgrade() -> None:
    ...
    sa.Column('status_production', sa.Enum('PREPARANDO_LANCHE', 'MONTANDO_COMBO', 'FINALIZADO', name='productionstatusenum', native_enum=False), nullable=False),
